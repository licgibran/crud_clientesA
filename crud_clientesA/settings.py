"""
Django settings for crud_clientesA project.
...
ROOT_URLCONF = 'crud_clientesA.urls'
...
WSGI_APPLICATION = 'crud_clientesA.wsgi.application'
...
DATABASES = {
    'default' : dj_database_url.config(
        default='postgresql://gibran:CmveOaTfeJWavG4nmDpCArxMCxOpgeyO@dpg-ct2tajt2ng1s73ed9680-a.oregon-postgres.render.com/burguer_76ig'
    )
}
